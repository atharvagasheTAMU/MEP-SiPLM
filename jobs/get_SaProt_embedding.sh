...
#SBATCH --job-name=get_SaProt_embedding       #Set the job name to "JobExample4"
...
export HF_HOME="$SCRATCH/MEP-SiPLM/ckpt/"
...
python get_SaProt_embedding.py --file_list ${FILE_LIST}
